...
let UserService = class UserService {
    ...
    async login(loginDto) {
        ...
        if (!isPasswordCorrect) {
            throw new common_1.HttpException('Password is incorrect', common_1.HttpStatus.UNPROCESSABLE_ENTITY);
        }
    ...
    buildUserResponse(user) {
        return Object.assign(Object.assign({}, user), { token: this.generateJwt(user) });
    }
};
