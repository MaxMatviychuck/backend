...
TypeModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([type_entity_1.TypeEntity, user_entity_1.UserEntity])],
        controllers: [type_controller_1.TypeController],
        providers: [type_service_1.TypeService, user_service_1.UserService, auth_guard_1.AuthGuard, admin_role_guard_1.AdminRoleGuard],
    })
], TypeModule);
