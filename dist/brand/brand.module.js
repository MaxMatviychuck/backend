...
BrandModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([brand_entity_1.BrandEntity, user_entity_1.UserEntity])],
        controllers: [brand_controller_1.BrandController],
        providers: [brand_service_1.BrandService, user_service_1.UserService, auth_guard_1.AuthGuard, admin_role_guard_1.AdminRoleGuard],
    })
], BrandModule);
